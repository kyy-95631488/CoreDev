...
export default function AddProject() {
  ...
  const [formData, setFormData] = useState({
    ...
    endDate: '',
    teamMembers: [],
    thumbnail: null, // Store file object locally
    thumbnailUrl: '',
    frameworks: [],
    previewLink: '',
    githubLink: '',
  ...
  // Handle thumbnail selection (store file locally, show preview)
  ...
  return (
    <div className="min-h-screen font-futura bg-gradient-to-br from-gray-900 via-blue-950 to-gray-900 text-gray-100 transition-colors duration-500 flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center p-4 sm:p-6 lg:p-8 pt-20 sm:pt-24 lg:pt-24">
        <motion.div
        ...
        >
          <h1 className="text-3xl sm:text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 text-center">
            Add New Project
          </h1>
          ...
          <motion.form
            ...
            className="bg-gray-800/80 rounded-lg p-6 sm:p-8 border border-blue-500/20"
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`mt-6 w-full flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-400 text-white rounded-lg font-semibold ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
              <FolderPlus size={20} />
